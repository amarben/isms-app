...
/**
 * Visual Demo for Scope Creation Process
 *
...
// Configure for visual demonstration with video recording (must be at top level)
test.use({
  launchOptions: {
...
test.describe('Visual Demo - Scope Creation Process', () => {
